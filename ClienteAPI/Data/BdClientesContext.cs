...
public partial class BdClientesContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)//go.microsoft.com/fwlink/?LinkId=723263.
    => optionsBuilder.UseSqlServer("Server=localhost;Database=ClienteDB;User Id=sa;Password=YourPassword123;TrustServerCertificate=True;");
